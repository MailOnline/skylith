...
function OpenIDProvider(options) {
    ...
    this.completeAuth = function(req, res, authResponse) {
        checkIdSetupComplete(req, res, authResponse);
    }

    this.rejectAuth = function(req, res, context) {
        checkIdSetupCancel(req, res, context);
    }
    ...
    function checkIdSetupCancel(req, res, context) {
    ...
    function checkIdSetupComplete(req, res, authResponse) {
