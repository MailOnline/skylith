...
function OpenIDProvider(options) {
    ...
    this.rejectAuth = function(req, res, context, next) {
        checkIdSetupCancel(req, res, context, next);
    }
    ...
    function checkIdSetup(request, req, res, message) {
        ...
        checkAuth(req, res, true, context);
    }

    function checkIdSetupCancel(req, res, context, next) {
